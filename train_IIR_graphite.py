...
if __name__ == '__main__':
    ...
    with open(os.path.join('datasets', 'PDAE_SPMe_cellGraphite_25degC.pickle'), "rb") as f:
        data = pickle.load(f)
    ...
    filename = os.path.join("datasets", f"IIR_cellGraphite_{TdegC:d}degC.pickle")
